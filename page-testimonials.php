						...
						?>
							...
							<div class="row full_width">
								<div class="column_one">
									<img src="<?php  echo esc_url( get_template_directory_uri() ); ?>/images/icon-quote-left.png" alt="Left Quote" />
								</div>
									...
									<?php 
									 ...
									 ?>
											<div class="image_wrap">
												<img src="<?php echo $thumb; ?>" alt="User Image"/>
											</div>
											
										<?php endif; ?>
										<div class="text_wrap">
											<p class="name">
												<?php the_sub_field('user_name'); ?> <span>|</span></p><p class="date"> <?php the_sub_field('date'); ?>
											</p>
										</div>
									</div>
								</div>
