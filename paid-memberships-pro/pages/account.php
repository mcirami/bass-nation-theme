			...
			<?php if(in_array('profile', $sections)) { ?>
				<div id="pmpro_account-profile" class="pmpro_box">
					...
					<div class="pmpro_actionlinks">
						...
						<a class="button yellow" href="<?php echo home_url()?>/membership-account/your-profile/?view=change-password"><?php _e('Change Password', 'pmpro');?></a>
					</div>
				...
				<div id="pmpro_account-membership" class="pmpro_box">
					...
					<div class="pmpro_actionlinks">
						...
						<?php if( array_key_exists($level->id, $pmpro_levels) && pmpro_isLevelExpiringSoon( $level ) ) { ?>
							<a class="button yellow" href="<?php echo pmpro_url("checkout", "?level=" . $level->id, "https")?>"><?php _e("Renew", "pmpro");?></a>
						<?php } ?>
