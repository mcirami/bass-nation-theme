			...
			<form id="pmpro_form" class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_form' ) ); ?>" action="<?php echo esc_url( pmpro_url( 'cancel', '', 'https') ) ?>" method="post">
				...
				<div class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_actionlinks' ) ); ?>">
					...
					if ( is_string( $old_level_ids ) && $old_level_ids == 'all' ) {
						...
						$cancel_memberships_text = __( 'Yes -  I\'m Resigning from Bass Nation', 'paid-memberships-pro' );
						$keep_memberships_text = __( 'No - I Changed My Mind', 'paid-memberships-pro' );
					}
					?>
					...
					<div class="full_width">
						<input type="submit" class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_btn pmpro_btn-submit pmpro_yeslink yeslink button red', 'pmpro_btn-submit' ) ); ?>" value="<?php echo esc_attr( $cancel_memberships_text ); ?>" />
					</div>
					<div class="full_width">
						<a class="<?php echo esc_attr( pmpro_get_element_class( 'pmpro_btn pmpro_btn-cancel pmpro_nolink nolink button yellow', 'pmpro_btn-cancel' ) ); ?>" href="<?php echo esc_url( pmpro_url( "account" ) ) ?>"><?php echo esc_html( $keep_memberships_text ); ?></a>
					</div>
				</div>
			</form>
			<?php
