 ...
 */
function d4p_get_post_attachments( $post_id ) : array {
	$args = array(
 ...
 */
function d4p_topic_attachments_count( $topic_id, $include_replies = false ) : int {
	global $wpdb;
 ...
 */
function d4p_bbattachment_handle_upload_error( &$file, $message ) : WP_Error {
