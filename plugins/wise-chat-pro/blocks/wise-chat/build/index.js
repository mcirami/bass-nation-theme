...
function Edit(_ref) {
  ...
  const [channelCandidate, setChannelCandidate] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  ...
  const renderSettingsLink = tag => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
      ...
      className: "",
      target: "_blank"
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Advanced Settings')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null));
  };
  ...
  function handleClick() {
    if (channelCandidate) {
      setAttributes({
        channel: '{' + [...getChannels(), channelCandidate].join(',') + '}'
      });
      setChannelCandidate('');
    }
  }
  function handleDelete(e, index) {
    e.preventDefault();
    setAttributes({
      channel: '{' + getChannels().filter((channel, channelIndex) => channelIndex !== index).join(',') + '}'
    });
  }
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    ...
    initialOpen: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", null, "Public channels:"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, getChannels().filter(channel => channel).map((channel, index, array) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, index + 1, ". ", channel, array.length > 1 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, " | ", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: "#",
    onClick: e => handleDelete(e, index)
  }, "delete"))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    label: "Add Channel",
    ...
    variant: "secondary",
    onClick: handleClick
  }, "Add")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CheckboxControl, {
