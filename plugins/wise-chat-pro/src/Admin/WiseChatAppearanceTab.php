...
class WiseChatAppearanceTab extends WiseChatAbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('window_title', 'Window Title', 'stringFieldCallback', 'string', 'Title of the window'),
			...
			array('hint_message', 'Hint Message', 'stringFieldCallback', 'string', 'A hint message displayed in the message input field'),
			...
			array('users_list_title', 'Users List Title', 'stringFieldCallback', 'string', 'Title of the browser'),
