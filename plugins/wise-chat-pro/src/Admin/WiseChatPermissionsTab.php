...
use Kainex\WiseChatPro\Model\WiseChatPrivateMessagesRule;
...
class WiseChatPermissionsTab extends WiseChatAbstractTab {
	...
	public function rulesCallback() {
		...
		foreach ($rules as $key => $rule) {
			...
			$deleteURL = admin_url("options-general.php?page=".WiseChatSettings::MENU_SLUG."&wc_action=deletePMRule&id=".urlencode($rule->getId())).'&wc_tab=permissions&nonce='.wp_create_nonce('deletePMRule');
			$deleteLink = sprintf(
