...
namespace Kainex\WiseChatPro\Integrations\Elementor\Addons;
...
class WiseChatAddon extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->addSelect('theme', esc_html__('Theme', 'wise-chat-pro'), array(
			'' => esc_html__('Default', 'wise-chat-pro'),
			'lightgray' => esc_html__('Light Gray', 'wise-chat-pro'),
			'colddark' => esc_html__('Cold Dark', 'wise-chat-pro'),
			'airflow' => esc_html__('Air Flow', 'wise-chat-pro'),
			'crystal' => esc_html__('Crystal', 'wise-chat-pro'),
			'clear' => esc_html__('Clear', 'wise-chat-pro'),
			'balloon' => esc_html__('Balloon', 'wise-chat-pro'),
		), 'lightgray');
		$this->addText('chat_width', esc_html__( 'Width', 'wise-chat' ), '100%');
		$this->addText('chat_height', esc_html__( 'Height', 'wise-chat' ), '500px');
		$this->addSelect('messages_order', esc_html__('Messages Order', 'wise-chat-pro'), array(
			'' => esc_html__('Newest on the bottom', 'wise-chat-pro'),
			'descending' => esc_html__('Newest on the top', 'wise-chat-pro'),
		), '');
		...
		$this->addSelect('messages_time_mode', esc_html__('Message Time Mode', 'wise-chat-pro'), array(
			'hidden' => esc_html__('Hidden', 'wise-chat-pro'),
			'' => esc_html__('Full', 'wise-chat-pro'),
			'elapsed' => esc_html__('Elapsed', 'wise-chat-pro'),
		), 'elapsed');
		$this->addCheckbox('show_avatars', esc_html__( 'Show Avatars', 'wise-chat' ), '1');
		$this->addColorSelector('background_color', esc_html__('Background Color', 'wise-chat-pro'), array('.wcChannel .wcMessages', '.wcChannel .wcMessages .wcMessage', '.wcChannel .wcMessages .wcMessage .wcContent'), 'background-color');
		$this->addColorSelector('text_color', esc_html__('Font Color', 'wise-chat-pro'), array('.wcMessages *'), 'color');
		...
		$this->addSelect('input_controls_location', esc_html__('Input Location', 'wise-chat-pro'), array(
			'' => esc_html__('Bottom', 'wise-chat-pro'),
			'top' => esc_html__('Top', 'wise-chat-pro'),
		), '');
		$this->addColorSelector('background_color_input', esc_html__('Background Color', 'wise-chat-pro'), array('.wcChannelInput', '.wcDesktop .wcBody .wcMessagesArea .wcCustomizations'), 'background-color');
		$this->addColorSelector('text_color_input_field', esc_html__('Font Color', 'wise-chat-pro'), array('.wcChannelInput *', '.wcDesktop .wcBody .wcMessagesArea .wcCustomizations *'), 'color');
		...
		$this->addSelect('browser_location', esc_html__('Location', 'wise-chat-pro'), array(
			'' => esc_html__('Right', 'wise-chat-pro'),
			'left' => esc_html__('Left', 'wise-chat-pro'),
		), '');
		...
		$this->addColorSelector('background_color_users_list', esc_html__('Background Color', 'wise-chat-pro'), array('.wcBody .wcBrowserArea', '.wcDesktop .wcBrowser'), 'background-color');
		$this->addColorSelector('text_color_users_list', esc_html__('Font Color', 'wise-chat-pro'), '.wcDesktop .wcBrowser *', 'color');
