...
namespace Kainex\WiseChatPro\Rendering\Filters\Pre;
...
class WiseChatLinksPreFilter {
	...
	*/
	 ...
	 */
	public function __construct(WiseChatImagesService $imagesService, WiseChatActions $actions, WiseChatAuthentication $authentication) {
