...
class WiseChatImagesService {
	...
	*/
	 ...
	 * @param WiseChatImageEditor $imageEditor
	 */
	public function __construct(WiseChatOptions $options, WiseChatImageEditor $imageEditor) {
	...
	*/
	public function getPreparedImage($binaryImageData) {
		...
		if (strlen($binaryImageData) > $this->options->getIntegerOption('images_size_limit', 3145728)) {
			throw new Exception(__('The size of the file exceeds allowed limit.', 'wise-chat-pro'));
		}
	...
	private function getTempFileImageInfo($safeResize) {
		...
		if (is_array($fileInfo)) {
			...
			if (!array_key_exists($mimeType, $this->supportedExtensions)) {
				...
				throw new Exception(__('Unsupported type of file', 'wise-chat-pro'));
			}
