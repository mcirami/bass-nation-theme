...
class WiseChatService {
	...
	*/
	 ...
	 */
	public function __construct(WiseChatUsersDAO $usersDAO, WiseChatChannelUsersDAO $channelUsersDAO, WiseChatChannelsDAO $channelsDAO, WiseChatUserService $userService, UserBansService $bansService, WiseChatAuthentication $authentication, WiseChatOptions $options) {
