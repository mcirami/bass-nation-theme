    ...
    <div class="panel <?php if(!$shareLink || !is_page(7)) { echo 'adjust';} ?>">
        ...
        <?php
            ...
            if ( str_contains( $str, "youtube" ) ) {
                $str = explode("embed/", $str);
                $embedCode = preg_replace('/\s+/', '',$str[1]);
                $type = "youtube";
            } elseif ( str_contains( $str, "vimeo" ) ) {
                ...
                <?php } ?>
                    ...
                    <?php elseif (!empty($postThumbnail)) :
                            ...
                            <?php } else { ?>
                                ...
                                <img class="screenshot" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/lessons-screenshot.jpg" alt="Video Thumbnail"/>
                    ...
                    <div class="button_wrap full_width">
                        <img class="play_button" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/play-button.png" alt="Play Button"/>
                    </div>
